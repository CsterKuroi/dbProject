...
<title>Kuro1</title>
    ...
    <link rel="stylesheet" type="text/css" href="./css/bnj2015.css"  />
	<link rel="shortcut icon" type="image/x-icon" href="favicon.ico" />
<meta content="kuro1的个人成长简历" name="description">
<meta content="简历,主页,成长,季豪,kuro1,kuroi,cster" name="keywords">
</head>
<body>

	
<div id="body">
    <div class="bnj-wrapper">
<!--         <div class="b2233_wrp b22"> -->
<!--             <div class="left_22" type="b22"></div> -->
<!--         </div> -->
        <div class="b2233_wrp b33">
            <div class="right_33" type="b33"></div>
        </div>
    </div>
    <script type="text/javascript" src="./js/bnj_2015.js"></script>
		...
		<div class="mr_myresume_l mrcenter">
			<div id="mr_mr_head">
				<div class="m_portrait mr_top_bg">
					...
					<img src="http://www.lagou.com/image2/M00/24/41/CgpzWlaMFXqAYoT3AAAooOXZxks265.jpg" width="120" height="120" alt="" />
				</div>
				<div class="mr_baseinfo">
					<i class="mr_left_bg"></i>
					<i class="mr_right_bg"></i>
					<div class="mr_p_name mr_w604 clearfixs">
						<span class="mr_name">季豪</span>
					</div>
					<div class="mr_p_introduce mr_w604 clearfixs">
						<span class="mr_intro">C/C++/java/Android/Ruby</span>
					</div>
					<div class="mr_p_info mr_infoed mr_w604 clearfixs">		
						...
						<div class="info_t">
							<span class="base_info"><i></i>男&nbsp;&nbsp;&nbsp;21岁&nbsp;&nbsp;&nbsp;本科 大三<span class="birth_span dn">1994.08年出生</span>&nbsp;&nbsp;&nbsp;浙江</span></div>
						<div class="info_b">
							<span class="mobile"><i></i>13051570168</span>&nbsp;&nbsp;
							<span class="email"><i></i>kuro1@foxmail.com</span>&nbsp;&nbsp; BUAA@7-622</div>
						<div class="mr_sns">
						<!--   -------------------社交账号     -----------------       -->
							<a href="http://github.com/CsterKuroi" target="_blank" data-sns="6" data-site="http://github.com/CsterKuroi"><span><em></em></span></a>
							<a href="http://www.zhihu.com/people/Kur01" target="_blank" data-sns="7" data-site="http://www.zhihu.com/people/Kur01"><span><em></em></span></a>
							<a href="http://weibo.com/wowcster" target="_blank	" data-sns="10" data-site="http://weibo.com/wowcster"><span><em></em></span></a>
						</div>
					</div>	
				</div>
			</div>	
						...
						<div>
							...
							<div class="list_show">
								...
								<div class="mr_content_m olpf">
									<ul>
 <li>云销售CRM客户关系管理系统</li>
 <li>开发环境：Android Studio</li>
 <li>项目描述：销售人员助理型APP，公司业务流程移动化。</li>
 <li>责任描述：负责Andorid端多个模块的设计和实现，本地SQLite数据库缓存实现，与云端服务器的交互实现。</li>
 <!-- <li>代码托管：<a target="_blank" href="http://github.com/CsterKuroi/android-trial">github.com/CsterKuroi/android-trial</a></li> -->
</ul>
								</div>	
								</div>
							</div>
								...
								<div class="clearfixs mb46 mr_jobe_list">
									<div class="mr_content_l">
										<div class="l1">
											...
											<img src="http://www.lagou.com/images/schoolBadge/63a7960051f544c99841d06c6ccf61b9.jpeg"/>
										</div>
										<div class="l2">
											<h4>北京航空航天大学</h4>
						...
						<div>
							...
							<div class="mr_moudle_content" id="projectList">
								...
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://github.com/CsterKuroi/yukariMini-SSP"><span></span>伪春菜开源合作项目</a>
											<p>程序猿</p>
										</div>
									</div>
								...
								<div class="mr_content_m olpf">
									<ul>
 <li>yukariMini-SSP</li>
 <li>开发环境：WINDOWS/Sakura Script Player/AYA-shiori</li>
 <li>项目简介：面向以@小缘粉丝为主要用户群体的桌面精灵养成软件</li>
 <li>合作者：//配音：Bilibili网络翻唱歌姬@小缘喵 //UI设计：pixiv画师@kuki菌</li>
 <li>责任描述：ghost（伪AI人格）构造，shell（外壳）代码接口</li>
 <li>代码托管：<a target="_blank" href="http://github.com/CsterKuroi/yukariMini-SSP">github.com/CsterKuroi/yukariMini-SSP</a></li>
</ul>
								</div>	
								</div>	
							</div>						
					...
					<!--<div id="worksShow">
						<div>
							<div class="mr_moudle_head clearfixs">
								<div class="mr_head_l">
									<div class="mr_title">
									<span class="mr_title_l"></span><span class="mr_title_c">个人主页</span><span class="mr_title_r"></span>
									</div>
								</div>
							</div>
							<div class="mr_moudle_content">
<div class="mr_moudle_content" id="projectList">
								...
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://www.acfun.tv/u/kuro1"><span></span>AcFun</a>
										</div>
										<br>
										<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://space.bilibili.com/2828630/"><span></span>Bilibili</a>
											</div>
											<br>
											<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://my.csdn.net/csterkuroi"><span></span>CSDN</a>
											</div>
											<br>
											<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://www.douyutv.com/331421"><span></span>douyutv</a>
											</div>
											<br>
											<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://www.nicovideo.jp/user/48476383"><span></span>niconico</a>
											</div>
											<br>
											<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://www.douban.com/people/138379637/"><span></span>豆瓣</a>
											</div>
																					</div>
									</div>
								</div>	
						...
						<div>
							...
							<div class="mr_moudle_content clearfixs">
								<div class="mr_self_l">
									...
									<i></i>
									<img src="http://www.lagou.com/image2/M00/24/41/CgpzWlaMFXqAYoT3AAAooOXZxks265.jpg" alt="季豪"/>
								</div>	
								<div class="mr_self_r">
									<p>有独立开发能力，具备团队开发经验，热衷于开源项目。<a href="http://cster.icoc.cc/">cster.icoc.cc</a></p>
							  </div>														
							</div>						
						</div>
					</div>					
					...
					<div id="expectJob">
						...
						<div class="mr_moudle_head clearfixs mr_w604">
							<div class="mr_head_l">
								<div class="mr_title">
									<span class="mr_title_l"></span><span class="mr_title_c">工作计划</span><span class="mr_title_r"></span>
								</div>
							</div>
						</div>
						<div class="mr_moudle_content clearfixs mr_w604">
							<div class="expectjob_list">
								...
								<div class="mr_job_info" data-id="$!expectJobses.id">
									<ul class="clearfixs">
										<li class="mr_name_li" ><i></i><span class="mr_job_name" title="全栈工程师">全栈工程师</span></li>
						...
						<div>
							...
							<div class="mr_moudle_content">
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="C">C</span>
									<span class="mr_skill_plan" data-skillLevel = "70">
									 <em style="width: 65%"></em>
									</span>
								...
								<div class="mr_skill_con">
									...
									<span class="mr_skill_plan" data-skillLevel = "75">
								...
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="Ruby">Ruby</span>
									<span class="mr_skill_plan" data-skillLevel = "59">
									 <em style="width: 59%"></em>
									</span>
									<span class="mr_skill_level">熟悉</span>
								</div>	
							</div>						
				...
				<div class="mr_self_state">
						...
						·&nbsp;Copyright © <a href="http://kuro1.com">kuro1</a> of  BUAA ·	   	 			</div>
				</div>
			</div>	
		  </div>
	    </div> 
